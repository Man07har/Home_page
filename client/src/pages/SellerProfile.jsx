        ...
        <div className="seller-profile-hero">
          <Flex bg={'#FEDAC1'}>
            ...
            <Box p="1em" w={'max'} flexGrow={'1'}>
              ...
              <Text padding={'1em'}>Pottery items made by locals INDIA</Text>
              <Grid templateColumns="repeat(2, 1fr)" gap={6}>
                <Text fontWeight={'bold'} fontSize={'xl'} padding={'1em'}>
                  Orders
                </Text>
                <Text fontWeight={'bold'} fontSize={'xl'} padding={'1em'}>
                  100
    ...
    <div>
      <Box w={'100%'} px="2em">
        <Flex>
          ...
          ></Box>
          <Box flexGrow={10} h={'10vh'} px="2em">
            <Stack>
              <Text textDecoration={'underline'}>
                <span className="font-bold">User1 </span> 17 September 2023
              </Text>
              <Text>
                {' '}
