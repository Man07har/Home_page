...
import MinimalComission from '../components/MinimalComission';
import GetToKnowThePlatform from '../components/GetToKnowThePlatform';
const Seller = () => {
  return (
    <>
      <div
        ...
        className="w-full h-full robotofont"
      >
        <SellerHero />
        <Stats />
        <SellerLoveSelling />
